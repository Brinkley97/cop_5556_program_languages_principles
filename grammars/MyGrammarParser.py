...
class MyGrammarParser ( Parser ):
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            localctx = MyGrammarParser.SingleTermContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    _prevctx = localctx
                    localctx = MyGrammarParser.AddSubContext(self, MyGrammarParser.ExprContext(self, _parentctx, _parentState))
    ...
    class MulDivContext(TermContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a MyGrammarParser.TermContext
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    def term(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = MyGrammarParser.TermContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            localctx = MyGrammarParser.SingleFactorContext(self, localctx)
            self._ctx = localctx
            _prevctx = localctx
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    if self._parseListeners is not None:
                        self.triggerExitRuleEvent()
                    _prevctx = localctx
                    localctx = MyGrammarParser.MulDivContext(self, MyGrammarParser.TermContext(self, _parentctx, _parentState))
    ...
    class ParensContext(FactorContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a MyGrammarParser.FactorContext
            super().__init__(parser)
            self.copyFrom(ctx)
